            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-team">
                        <div class="image">
                            <img src="{{ asset('/website') }}/assets/images/team/01.jpg" alt="#">
                        </div>
                        <div class="content">
                            <div class="info">
                                <h3>Grace Wright</h3>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-team">
                        <div class="image">
                            <img src="{{ asset('/website') }}/assets/images/team/02.jpg" alt="#">
                        </div>
                        <div class="content">
                            <div class="info">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-team">
                        <div class="image">
                            <img src="{{ asset('/website') }}/assets/images/team/03.jpg" alt="#">
                        </div>
                        <div class="content">
                            <div class="info">
                                <h3>Quinton Cross</h3>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-team">
                        <div class="image">
                            <img src="{{ asset('/website') }}/assets/images/team/04.jpg" alt="#">
                        </div>
                        <div class="content">
                            <div class="info">
                                <h3>Liana Mullen</h3>
